...
\end{lstlisting}
Za tem se kliče metoda \verb|initialize/2|, ki
gonilnemu objektu poda omrežni naslov naprave in poverilnice.
\\\\
...
ki implementirajo vmesnik \verb|Tab|, te se instancirajo in vrnejo v
metodi. Ospredni del nato z orodnim razredom \verb|ContentRenderer|
generira stran, kot je prikazana spodaj.

\begin{center}
	\includegraphics[scale=0.3]{slike/config-window.png}
